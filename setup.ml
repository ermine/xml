...
(* OASIS_START *)
(* DO NOT EDIT (digest: afa0f497f2330756116416c02e2f9129) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "Xml parser for discrete data";
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Compile testing with ocaml-text";
                      flag_default = [(OASISExpr.EBool true, false)];
                      });
               Flag
                 ({
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Xml"; "Xmllexer_generic"; "Xmllexer"; "Light_xml"];
                      lib_pack = false;
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "\020¹W!&\000R\r‚»m\000~VÙ’";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
